  ...
  receiveMessages: function() {
    ...
    App.contracts.BlockChat.deployed().then(function(instance) {
      ...
      for (var m = 0; m < myInboxSize; m++) {
        ...
        cell2.style.backgroundColor=" #667aff";
        cell2.style.color="#FFFF";
        cell2.style.height="35px";
        cell2.style.borderRadius="0px 30px 30px 0px";

        cell2.style.width="22vw";

        cell2.style.padding="1.5vh";
        
        
        var cell1 = row.insertCell();
        cell1.innerHTML = ":~$";
        cell1.style.color="#5cb85c";
        

        var cell3 = row.insertCell();
        cell3.style.backgroundColor=" #667aff";

        cell3.style.color="#FFFF";

        cell3.style.padding="1.5vh";
        cell3.style.borderRadius="7px";
      ...
      clearInboxButton.className = "btn"
      clearInboxButton.id = "clearInboxButton";
      clearInboxButton.style.marginLeft="10px";
     
      clearInboxButton.innerHTML = "Clear inbox";
      document.getElementById("chat-form").appendChild(clearInboxButton);
